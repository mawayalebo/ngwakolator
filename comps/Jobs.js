...
const Jobs = () => {
    ...
    return ( 
        <div className="absolute top-[80vh] w-full h-full">
            { 
                jobs.length > 0 && 
            ...
            <div className="bg-black rounded-t-[60px] w-full h-full">
                {
                    jobs.length > 0 && 
                    <div class="p-10 flex flex-col ">
                        {
                            jobs.map((job, index)=>{
                                return(
                                    <div className="bg-[whitesmoke] w-full flex items-center p-5 mb-1 justify-evenly" key={index}>
                                        ...
                                        <div class="bg-[grey] rounded-full text-black flex items-center justify-center border-black border-solid border-1 shadow-lg w-5 h-5 p-3">
                                            <Close/>
                                        </div>
                                    </div>
                                )
